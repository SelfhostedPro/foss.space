...
import { SocialLoginButton, type SocialProvider } from '@/components/auth/SocialLoginButton'
...
function AuthPage() {
  ...
  const handleSocialLogin = async (provider: SocialProvider) => {
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : `${provider} login failed. Please try again.`;
    ...
    <div className="max-w-md mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Continue with your preferred account to sign in or create a new account
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
